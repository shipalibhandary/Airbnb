...
function App() {
      ...
      <div className="border-b sticky top-0 bg-white z-40">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
          ...
          <div className="hidden md:flex items-center border rounded-full px-5 py-2 shadow-sm hover:shadow-md transition cursor-pointer bg-white">
            ...
            <div className="ml-4 bg-[#c89b8a] text-white p-2 rounded-full">
              🔍
            </div>
          </div>
  ...
  <div className="max-w-7xl mx-auto px-6 py-16">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
      ...
      <div>
        <h1
          className="text-4xl font-semibold text-[#c89b8a] tracking-wide"
          style={{
      ...
      {/* Explore */}
      <div>
        <h3 className="text-xs uppercase tracking-[0.3em] text-gray-500 mb-6">
          Explore
        </h3>
